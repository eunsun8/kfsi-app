...
defaults: // Defaults Settings
{
  ...
  setButton: 
  {
    markup: "<a id='ap-button-set' class='btn btn-lg btn-primary' style='width: 140px'>Set</a>",
  ...
  cancelButton: 
  {
    markup: "<a id='ap-button-cancel' class='btn btn-lg btn-outline-secondary' style='width: 140px'>취소</a>",
...
_parseInputDateTime: function(sDate)
{
  ...
  if(typeof sDate === "string")
  {
    ...
    {
      if(($.CF.compareStrings(oDate.me, "오전") || $.CF.compareStrings(oDate.sm, "A")) && oDate.h === 12)
        oDate.H = 0;
      else if(($.CF.compareStrings(oDate.me, "오후") || $.CF.compareStrings(oDate.sm, "P")) && oDate.h < 12)
        oDate.H = oDate.h + 12;
      else
        oDate.H = oDate.h;
    }
